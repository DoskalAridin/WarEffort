...
for "_i" from dateToNumber [1968, _systemMonth, 1, 0, 0] to dateToNumber [1968, _systemMonth, 31, 23, 59] step 1 / 365 do
{
    _date = numberToDate [1968, _i];
