if (MACVresource > 100) then {
    ...
    [_LPOP,
     ...
     {},
     {},
     {_pos = getPos _target; deleteVehicle _target; [_pos, 0, SelectRandom MACVfobs] remoteExec ["BIS_fnc_objectsMapper", 2]; [west, _pos] remoteExec ["BIS_fnc_addRespawnPosition",2]},
     {},
     [],
     15,
     1000,
