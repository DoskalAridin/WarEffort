...
_availableMainAOs = BLUFORterritory - ["markerHQ"];
...
_objOfficer addEventHandler ["Killed", {["mainOperation_officer" ,"FAILED"] call BIS_fnc_taskSetState; BLUFORresource = floor (BLUFORresource - (enemyStrengthMissionFailPenalty * 2)); publicVariable "BLUFORresource"; OperationOfficer = false; publicVariable "OperationOfficer";}];
