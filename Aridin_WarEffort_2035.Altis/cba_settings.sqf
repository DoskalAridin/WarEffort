...
force force ace_advanced_fatigue_terrainGradientFactor = 0.25;
...
force force ace_nightvision_fogScaling = 0.111914;
force force ace_nightvision_noiseScaling = 0.2;
ace_nightvision_shutterEffects = true;

// ACE Overheating
force force ace_overheating_cookoffCoef = 2;
...
force force ace_repair_repairDamageThreshold_engineer = 0.797184;
...
force ace_viewdistance_limitViewDistance = 2876;
ace_viewdistance_objectViewDistanceCoeff = 0;
ace_viewdistance_viewDistanceAirVehicle = 3860;
ace_viewdistance_viewDistanceLandVehicle = 2138;
ace_viewdistance_viewDistanceOnFoot = 2138;
...
// Aridin's Addons Settings
force ARDN_sideRelationsBLUFOR = "default";
force ARDN_sideRelationsOPFOR = "default";
force ARDN_tkTime = 60;
...
zen_visibility_maxDistance = 2000;
...
zen_faction_filter_0_ARDN_org = false;
zen_faction_filter_0_ARDN_sogpf_zeon = true;
...
zen_faction_filter_1_ARDN_fbc_FBC = false;
zen_faction_filter_1_ARDN_sogpf_EFF = true;
...
zen_faction_filter_2_ARDN_gg_gekkoGhost = false;
